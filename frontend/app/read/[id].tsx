...
export default function StoryReader() {
  ...
  const { mutate: regenerateSpread, isPending: isRegenerating } = useRegenerateSpread();
  ...
  return (
    ...
    >
      ...
      <View style={{
        ...
        {/* Right side buttons - Edit or Retry based on illustration status */}
          ...
          {!showEndScreen && story.is_illustrated && currentSpreadData && (
            currentSpreadData.illustration_status === 'failed' ? (
              ...
              <Pressable
                ...
                disabled={isRegenerating}
                style={{
                  backgroundColor: isRegenerating ? '#999' : '#F97316',
                  paddingVertical: 16,
                  paddingHorizontal: 22,
                  borderRadius: 22,
                  alignItems: 'center',
